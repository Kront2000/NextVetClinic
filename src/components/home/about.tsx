        ...
        <div className="p-4 sm:px-8">
          ...
          <div className="flex flex-col-reverse md:flex-row mt-10 lg:mt-14 xl:mt-22 2xl:mt-32 gap-12 sm:gap-20 md:gap-2 2xl:justify-between">
            ...
            <div className="grid w-full grid-cols-1 md:grid-cols-2 gap-6 md:gap-2 px-2 md:w-[70%] lg:w-[65%] 2xl:w-[55%] h-fit items-end ">
              <img src="about.webp" className="w-full aspect-2/3 object-cover rounded-2xl shadow-2xl" alt="" />
              <div className=" flex flex-col gap-2 w-full">
                <div className="grid grid-cols-2 gap-2 w-full">
                  <img src="spec5.webp" className="w-full aspect-square object-cover rounded-4xl shadow-2xl" alt="" />
                  <img src="spec6.webp" className="w-full aspect-square object-cover rounded-4xl shadow-2xl" alt="" />
                </div>
                <img src="about2.webp" className="w-full  aspect-3/2 object-cover rounded-2xl shadow-2xl" alt="" />
              </div>
