...
export const CreateCategoryProcedureForm: React.FC<Props> = ({ className, modalType, setModalType }) => {
  ...
  return (
    <div className={cn('z-100', className)}>
      <div className={cn(modalType == 'addCat' ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none', "transition duration-300 z-50")}>
        <div
        ...
        <div className="fixed flex flex-col items-center w-72 p-4 bg-white rounded-2xl left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          ...
          <form onSubmit={(e) => onSubmit(e, '/api/categoryProcedure')} className="flex flex-col w-full items-center gap-8" action="">
            ...
            <div className="flex flex-col items-center max-w-full">
              ...
              <input type="file" accept="image/*" className="border-1 max-w-full rounded-lg" name="image" />
            </div>
